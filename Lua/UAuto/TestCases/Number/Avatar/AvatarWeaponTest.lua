...
local weaponList = {"11101","11201","11301","11302","11401","11402","11403","11404","11501","11502"}
...
self.SwordCheck = {
	...
	Action = UAutoCoroutine(function()
		...
		for key,weaponId in ipairs(weaponList) do
			local maxLevel = self.base:GetWeaponUnlockMaxLevel(weaponId,promoteLevel)
			if maxLevel==20 then
				for i=1,20,step do
			...
			if maxLevel==40 then
				for i=20,40,step do
					...
					gmCmd = "EQUIP ADD "..weaponId.." "..i .. " "..tostring(promoteLevel)
					yield_return(self.base:RunGM(gmCmd))
