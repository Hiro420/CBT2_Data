...
local UAutoLuaTestCase = class("RoundXinshouToMengde",baseClass)
local self = UAutoLuaTestCase
self.TestFixture = "RoundXinshouToMengde"
self.Category = "Security"
self.Description = "安全测试-新手区到蒙得来回跑"
...
self.Step1 = {
	...
	Action = UAutoCoroutine(function()
		...
		while true do
			...
			for i=#(self.posTableXinshouToMengde), 1, -1 do
				pos = self.posTableXinshouToMengde[i]
				yield_return(self.base:MoveToPosition(pos, 10, 1, 0.5,true))
			end
