...
local UAutoLuaTestCase = class("ElectricIceReaction", baseClass)
local self = UAutoLuaTestCase
self.TestFixture = "ElectricIceReaction"
self.Category = "元素"
self.Description = "元素反应-电<-冰"
