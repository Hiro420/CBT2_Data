...
local UAutoLuaTestCase = class("RunSceneDihuazhou",baseClass)
local self = UAutoLuaTestCase
self.TestFixture = "RunSceneDihuazhou"
self.Category = "TA测试" --自行修改分类
self.Description = "TA_遍历：荻花洲" --自行修改用例描述
...
yield_return(self.base:Jump())
            ...
            -- 开启性能采集
            local gm_startStatUnit = string.format("StartStatUnit Test@Server-Case@FixedPoints@%s", 'TARunSceneDihuazhouDaily')
