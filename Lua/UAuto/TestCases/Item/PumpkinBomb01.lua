...
UAutoLuaTestCase.FireOnPumpkinBomb01 = {
	...
	Action = UAutoCoroutine(function()
		...
		CS.MoleMole.SuperDebug.Log(CS.MoleMole.SuperDebug.AUTO_TEST,self.oldCount)
...
UAutoLuaTestCase.WaitPumpkinBombFinish = {
	...
	Action = UAutoCoroutine(function()
		...
		CS.MoleMole.SuperDebug.Log(CS.MoleMole.SuperDebug.AUTO_TEST,self.oldCount - self.newCount)
