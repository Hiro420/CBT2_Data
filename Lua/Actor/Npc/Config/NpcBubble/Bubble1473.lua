...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016147300,Mode=TalkModeData.BOTH,BubbleTime=1.8,BubbleInterval={20,30}},
		{Id=1016147301,Mode=TalkModeData.BOTH,BubbleTime=2.8,BubbleInterval={20,30}},
	},
}
