...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016142100,Mode=TalkModeData.BOTH,BubbleTime=4.6,BubbleInterval={20,30}},
		{Id=1016142101,Mode=TalkModeData.BOTH,BubbleTime=4.8,BubbleInterval={20,30}},
	},
}
