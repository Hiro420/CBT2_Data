...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016146700,Mode=TalkModeData.BOTH,BubbleTime=3.9,BubbleInterval={20,30}},
		{Id=1016146701,Mode=TalkModeData.BOTH,BubbleTime=3.4,BubbleInterval={20,30}},
	},
}
