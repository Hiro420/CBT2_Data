...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016147100,Mode=TalkModeData.BOTH,BubbleTime=2.5,BubbleInterval={20,30}},
		{Id=1016147101,Mode=TalkModeData.BOTH,BubbleTime=1.7,BubbleInterval={20,30}},
	},
}
