...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016140500,Mode=TalkModeData.BOTH,BubbleTime=4.3,BubbleInterval={20,30}},
		{Id=1016140501,Mode=TalkModeData.BOTH,BubbleTime=5.0,BubbleInterval={20,30}},
	},
}
