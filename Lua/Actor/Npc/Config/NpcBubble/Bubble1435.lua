...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016143500,Mode=TalkModeData.BOTH,BubbleTime=2.4,BubbleInterval={20,30}},
		{Id=1016143501,Mode=TalkModeData.BOTH,BubbleTime=3.3,BubbleInterval={20,30}},
	},
}
