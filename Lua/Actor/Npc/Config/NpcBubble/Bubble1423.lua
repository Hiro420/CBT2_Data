...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016142300,Mode=TalkModeData.BOTH,BubbleTime=2.0,BubbleInterval={20,30}},
		{Id=1016142301,Mode=TalkModeData.BOTH,BubbleTime=3.3,BubbleInterval={20,30}},
	},
}
