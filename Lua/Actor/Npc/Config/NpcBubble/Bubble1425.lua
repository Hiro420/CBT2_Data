...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016142500,Mode=TalkModeData.BOTH,BubbleTime=3.5,BubbleInterval={20,30}},
		{Id=1016142501,Mode=TalkModeData.BOTH,BubbleTime=4.1,BubbleInterval={20,30}},
	},
}
