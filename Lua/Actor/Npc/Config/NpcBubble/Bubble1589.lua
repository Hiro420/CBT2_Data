...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016158900,Mode=TalkModeData.BOTH,BubbleTime=3.3,BubbleInterval={20,30}},
		{Id=1016158901,Mode=TalkModeData.BOTH,BubbleTime=1.6,BubbleInterval={20,30}},
	},
}
