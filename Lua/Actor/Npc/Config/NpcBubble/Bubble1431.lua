...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016143100,Mode=TalkModeData.BOTH,BubbleTime=3.8,BubbleInterval={20,30}},
		{Id=1016143101,Mode=TalkModeData.BOTH,BubbleTime=3.6,BubbleInterval={20,30}},
	},
}
