...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
--		{Id=1016141100,Mode=TalkModeData.BOTH,BubbleTime=4.2,BubbleInterval={20,30}},
--		{Id=1016141101,Mode=TalkModeData.BOTH,BubbleTime=3.4,BubbleInterval={20,30}},
	},
}
