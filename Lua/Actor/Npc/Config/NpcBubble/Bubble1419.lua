...
NPCConfig.Data =
{
	...
	--随机选择一条进行播放
	DialogData={
		{Id=1016141900,Mode=TalkModeData.BOTH,BubbleTime=2.1,BubbleInterval={20,30}},
		{Id=1016141901,Mode=TalkModeData.BOTH,BubbleTime=2.8,BubbleInterval={20,30}},
	},
}
