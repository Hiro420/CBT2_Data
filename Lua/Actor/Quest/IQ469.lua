...
function Quest469:OnDataLoaded()
    q469Cfg = self.clientData
    subIDs = q469Cfg.SubIDs
    PaimonData = q469Cfg.PaimonData
end
...
function Quest469:OnSubFinish46904(quest)
	...
	self:NarratorOnlyTask(self.clientData.NarratorData.Story2, nil, "StoryCut")
end
...
function Quest469:OnSubFinish46902(quest)
	...
	--self:CreateQuestNpcById(46902, PaimonData.Paimon, 1)
