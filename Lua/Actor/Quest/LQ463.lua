...
function Quest463:Soldier1Enter()
    local soldier1 = self:GetQuestNpcActor(SoldierData.Alias1)
...
function Quest463:Soldier2Enter()
    local soldier2 = self:GetQuestNpcActor(SoldierData.Alias2)
...
function Quest463:NPCEnter()
    local npc = self:GetQuestNpcActor(npcBossData.NpcBoss)
    npc:SetVisible(true)
    --kaeya:AddPriorityInter(InterTimingType.BTN, self.clientData.InterData.NoReplyInter)	
    print("463 NPCEnter")
...
function Quest463:StartTalk46300()
    ...
    self:CreateQuestNpcById(46300, paimonData.ID)    
    self:CallDelay(0.2,
        function(self)
...
function Quest463:StartTalk46301()
    ...
    self:CreateQuestNpcById(46301, paimonData.ID) 
    self:CallDelay(0.2,
        function(self)
...
function Quest463:StartTalk()
    ...
    self:CreateQuestNpcById(46303, paimonData.ID) 
    self:CallDelay(0.2,
        function(self)
            self:RequestInteraction(paimonData.Alias)
        end 
