...
local Q1200003Trigger = class("Q1200003Trigger", gadgetActorProxy)

Q1200003Trigger.defaultAlias = "Q1200003Trigger"
...
function Q1200003Trigger:OnPostDataPrepare()
end

function Q1200003Trigger:OnPostComponentPrepare()
	self:AddComponentTrigger(8, DistType.EULER, M.Pos(0, 0.8, 0), self.TriggerIn, self.TriggerOut)
end

function Q1200003Trigger:TriggerIn()
...
function Q1200003Trigger:TriggerOut()
	--print("Exit " .. tostring(outCnt))
	--self:DestroySelf()
	print("35301 start: 111")
end

return Q1200003Trigger