...
local Q1200107Trigger = class("Q1200107Trigger", gadgetActorProxy)

Q1200107Trigger.defaultAlias = "Q1200107Trigger"
...
function Q1200107Trigger:OnPostDataPrepare()
end

function Q1200107Trigger:OnPostComponentPrepare()
	self:AddComponentTrigger(5, DistType.EULER, M.Pos(0, 0.8, 0), self.TriggerIn, self.TriggerOut)
end

function Q1200107Trigger:TriggerIn()
...
function Q1200107Trigger:TriggerOut()
	--print("Exit " .. tostring(outCnt))
	--self:DestroySelf()
	print("35301 start: 111")
end

return Q1200107Trigger