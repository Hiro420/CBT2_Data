...
local Q1200203Trigger = class("Q1200203Trigger", gadgetActorProxy)

Q1200203Trigger.defaultAlias = "Q1200203Trigger"
...
function Q1200203Trigger:OnPostDataPrepare()
end

function Q1200203Trigger:OnPostComponentPrepare()
	self:AddComponentTrigger(3, DistType.EULER, M.Pos(0, 0.8, 0), self.TriggerIn, self.TriggerOut)
end

function Q1200203Trigger:TriggerIn()
...
function Q1200203Trigger:TriggerOut()
	--print("Exit " .. tostring(outCnt))
	--self:DestroySelf()
	print("35301 start: 111")
end

return Q1200203Trigger