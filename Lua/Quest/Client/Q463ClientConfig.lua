...
QuestClientData.NarratorData = {
	Story1 = {
    	{dialogID = 4630339, audioEvtName = "", duration = 4},
		{dialogID = 4630340, audioEvtName = "", duration = 6},
		{dialogID = 4630341, audioEvtName = "", duration = 3},
		{dialogID = 4630342, audioEvtName = "", duration = 6},
		{dialogID = 4630343, audioEvtName = "", duration = 6},
	},
}
