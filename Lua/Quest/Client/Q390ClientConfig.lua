...
QuestClientData.NarratorData =
{
    ...
    OpenOrgan1 =
    {
        {dialogID = 3900801, duration = 4},
        {dialogID = 3900802, duration = 4},
        {dialogID = 3900803, duration = 3}
    },

    OpenOrgan2 =
    {
        {dialogID = 3910801, duration = 4},
        {dialogID = 3910802, duration = 4},
    },

    OpenOrgan3 =
    {
        {dialogID = 3920801, duration = 1},
        {dialogID = 3920802, duration = 4},
    },
...
QuestClientData.LookCameraData =
{
    LookPos1 = sceneData:GetDummyPoint(3,"Q394Target1").pos
}
