...
-- 	SoldierID = 1484,
--     bornPos = sceneData:GetDummyPoint(3,"Q427Soilder1").pos,
--     bornDir = sceneData:GetDummyPoint(3,"Q427Soilder1").rot,
-- }
...
QuestClientData.Soldier2Data = 
{
	...
	SoldierScript = "Actor/Quest/Q376/Soldier",
	SoldierID = 1483,
    bornPos = sceneData:GetDummyPoint(3,"Q427Soilder2").pos,
	bornDir = sceneData:GetDummyPoint(3,"Q427Soilder2").rot,		
}
...
QuestClientData.AmborData = 
{
	...
	appearPos = sceneData:GetDummyPoint(3,"42708Ambor").pos,
	appearDir = sceneData:GetDummyPoint(3,"42708Ambor").rot,	
	hiddenPos = sceneData:GetDummyPoint(3,"42708AmborHidden").pos,
	hiddenDir = sceneData:GetDummyPoint(3,"42708AmborHidden").rot,	

}

QuestClientData.CoinNum = 12
...
QuestClientData.FlyCoins = 
{
	...
	},
	{
		...
		sceneData:GetDummyPoint(3,"FlyCoin123")
	},
	{
...
QuestClientData.ArrNarrator =
{
	{dialogID = 4270800, audioEvtName = "", duration = 4},
