...
QuestClientData.NarratorData = {
	Story1 = {
        {dialogID = 3890101, duration = 3},
        {dialogID = 3890102, duration = 8},
		{dialogID = 3890103, duration = 4},
		{dialogID = 3890104, duration = 4},
	},

	Story2 = {
        {dialogID = 3890401, duration = 5},
        {dialogID = 3890402, duration = 5},
		{dialogID = 3890403, duration = 2},
		{dialogID = 3890404, duration = 8},
		{dialogID = 3890405, duration = 5},
		{dialogID = 3890406, duration = 2},
		{dialogID = 3890407, duration = 6},
		{dialogID = 3890408, duration = 6},
		{dialogID = 3890409, duration = 3},
	},
